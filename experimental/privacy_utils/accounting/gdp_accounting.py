...
if __name__ == "__main__":
    # TODO: The problem is that with small sigma, mu is very large.
    mu = compute_mu_poisson(
        epochs=10, noise_multi=0.1, sample_rate=0.02,
    )
    print(mu)

    # TODO: Another problem is that large mu will blow up the root finding procedure.
    mu = 30
    delta = 1e-5
    eps = eps_from_mu(mu, delta, bracket=(0, 500))
